...
var Ka=/:(nth[-\w]+)\(([^)]+)\)/,bb=":not(.style-scope)",Ia=",",Pa=/(^|[\s>+~]+)((?:\[.+?\]|[^\s>+~=[])+)/g,Ya=/[[.:#*]/,M=":host",ab=":root",Ra="::slotted",Oa=new RegExp("^("+Ra+")"),Xa=/(:host)(?:\(((?:\([^)(]*\)|[^)(]*)+?)\))/,Ua=/(?:::slotted)(?:\(((?:\([^)(]*\)|[^)(]*)+?)\))/,Va=/(.*):dir\((?:(ltr|rtl))\)/,Ga=".",Wa=":",Ca="class",Za="should_not_match",Ma=/:(?:matches|any|-(?:webkit|moz)-any)/,H=new G;function N(a,b,c,e){this.j=a||null;this.b=b||null;this.A=c||[];this.o=null;this.u=e||"";this.a=this.h=this.m=null}function O(a){return a?a.__styleInfo:null}function cb(a,b){return a.__styleInfo=b}N.prototype.c=function(){return this.j};N.prototype._getStyleRules=N.prototype.c;function db(a){var b=this.matches||this.matchesSelector||this.mozMatchesSelector||this.msMatchesSelector||this.oMatchesSelector||this.webkitMatchesSelector;console.log("matchesSelector","method",b,"typeof method",typeof b,"selector",a,"typeof selector",typeof a,"this",this,"typeof this",typeof this);var c=!1;try{c=b&&"function"===typeof b&&b.call(this,a)}catch(e){console.log(e)}return c}var eb=navigator.userAgent.match("Trident");function fb(){}
function gb(a){var b={},c=[],e=0;z(a,function(a){Q(a);a.index=e++;a=a.f.cssText;for(var c;c=ra.exec(a);){var d=c[1];":"!==c[2]&&(b[d]=!0)}},function(a){c.push(a)});a.b=c;a=[];for(var d in b)a.push(d);return a}function Q(a){if(!a.f){var b={},c={};R(a,c)&&(b.i=c,a.rules=null);b.cssText=a.parsedCssText.replace(ua,"").replace(v,"");a.f=b}}
function R(a,b){var c=a.f;if(c){if(c.i)return Object.assign(b,c.i),!0}else{c=a.parsedCssText;for(var e;a=v.exec(c);){e=(a[2]||a[3]).trim();if("inherit"!==e||"unset"!==e)b[a[1].trim()]=e;e=!0}return e}}function S(a,b,c){b&&(b=0<=b.indexOf(";")?hb(a,b,c):za(b,function(b,d,f,g){if(!d)return b+g;(d=S(a,c[d],c))&&"initial"!==d?"apply-shim-inherit"===d&&(d="inherit"):d=S(a,c[f]||f,c)||f;return b+(d||"")+g}));return b&&b.trim()||""}
